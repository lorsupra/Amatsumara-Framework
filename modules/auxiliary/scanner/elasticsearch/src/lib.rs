...
static NAME: &str = "Elasticsearch Banner Scanner";
static DESCRIPTION: &str = "Scans for Elasticsearch servers and retrieves version banners";
...
static RPORT_DESC: &str = "Elasticsearch port";
static RPORT_DEFAULT: &str = "9200";
...
impl ScannerModule {
    fn new() -> Box<Self> { Box::new(Self { rhost: String::new(), rport: 9200, timeout: 5 }) }
    ...
    async fn run_scan(&self) -> i32 {
        eprintln!("[*] Elasticsearch Scanner - Target: {}:{}", self.rhost, self.rport);
