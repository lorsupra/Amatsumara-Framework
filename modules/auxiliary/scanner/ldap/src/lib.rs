...
static NAME: &str = "LDAP Banner Scanner";
static DESCRIPTION: &str = "Scans for LDAP servers and retrieves version banners";
...
static RPORT_DESC: &str = "LDAP port";
static RPORT_DEFAULT: &str = "389";
...
impl ScannerModule {
    fn new() -> Box<Self> { Box::new(Self { rhost: String::new(), rport: 389, timeout: 5 }) }
    ...
    async fn run_scan(&self) -> i32 {
        eprintln!("[*] LDAP Scanner - Target: {}:{}", self.rhost, self.rport);
