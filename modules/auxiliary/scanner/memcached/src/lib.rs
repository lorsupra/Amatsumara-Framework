...
static NAME: &str = "Memcached Banner Scanner";
static DESCRIPTION: &str = "Scans for Memcached servers and retrieves version banners";
...
static RPORT_DESC: &str = "Memcached port";
static RPORT_DEFAULT: &str = "11211";
...
impl ScannerModule {
    fn new() -> Box<Self> { Box::new(Self { rhost: String::new(), rport: 11211, timeout: 5 }) }
    ...
    async fn run_scan(&self) -> i32 {
        eprintln!("[*] Memcached Scanner - Target: {}:{}", self.rhost, self.rport);
