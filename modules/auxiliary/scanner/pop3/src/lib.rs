...
static NAME: &str = "POP3 Banner Scanner";
static DESCRIPTION: &str = "Scans for POP3 servers and retrieves banners";
...
static RPORT_DESC: &str = "POP3 port";
