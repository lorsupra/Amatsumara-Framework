...
static NAME: &str = "VNC Banner Scanner";
static DESCRIPTION: &str = "Scans for VNC servers and retrieves banners";
...
static RPORT_DESC: &str = "VNC port";
